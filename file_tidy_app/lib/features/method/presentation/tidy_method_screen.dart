...
class TidyMethodScreen extends StatefulWidget {
  const TidyMethodScreen({
    super.key,
  ...
  @override
  State<TidyMethodScreen> createState() => _TidyMethodScreenState();
}

class _TidyMethodScreenState extends State<TidyMethodScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: const Text('Tidy Files')),
      body: ListView(
